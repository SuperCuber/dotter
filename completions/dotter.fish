...
complete -c dotter -n "__fish_seen_subcommand_from gen-completions" -s s -l shell -d 'Set the shell for generating completions [values: bash, elvish, fish, powershell, zsh, nushell]' -r -f -a "{bash	,elvish	,fish	,powershell	,zsh	,nushell	}"
...
complete -c dotter -n "__fish_seen_subcommand_from gen-completions" -s h -l help -d 'Print help information'
